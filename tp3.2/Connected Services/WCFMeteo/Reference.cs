...
namespace tp3._2.WCFMeteo {
    ...
    public interface IService1 {
        ...
        tp3._2.WCFMeteo.Get_ValueResponse Get_Value(tp3._2.WCFMeteo.Get_ValueRequest request);
        
        // CODEGEN : Génération du contrat de message dans la mesure où l'opération compte plusieurs valeurs de retour.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_Value", ReplyAction="http://tempuri.org/IService1/Get_ValueResponse")]
        System.Threading.Tasks.Task<tp3._2.WCFMeteo.Get_ValueResponse> Get_ValueAsync(tp3._2.WCFMeteo.Get_ValueRequest request);
        ...
        tp3._2.WCFMeteo.MeteoData Get_MeteoData();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_MeteoData", ReplyAction="http://tempuri.org/IService1/Get_MeteoDataResponse")]
        System.Threading.Tasks.Task<tp3._2.WCFMeteo.MeteoData> Get_MeteoDataAsync();
        ...
        tp3._2.WCFMeteo.MeteoData Get_MeteoDataByDateTime(string s_DateValueIn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Get_MeteoDataByDateTime", ReplyAction="http://tempuri.org/IService1/Get_MeteoDataByDateTimeResponse")]
        System.Threading.Tasks.Task<tp3._2.WCFMeteo.MeteoData> Get_MeteoDataByDateTimeAsync(string s_DateValueIn);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Channel : tp3._2.WCFMeteo.IService1, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1Client : System.ServiceModel.ClientBase<tp3._2.WCFMeteo.IService1>, tp3._2.WCFMeteo.IService1 {
        ...
        tp3._2.WCFMeteo.Get_ValueResponse tp3._2.WCFMeteo.IService1.Get_Value(tp3._2.WCFMeteo.Get_ValueRequest request) {
        ...
        public string Get_Value(int i_NumValue, out string s_DateValue, out string s_DescValue) {
            tp3._2.WCFMeteo.Get_ValueRequest inValue = new tp3._2.WCFMeteo.Get_ValueRequest();
            inValue.i_NumValue = i_NumValue;
            tp3._2.WCFMeteo.Get_ValueResponse retVal = ((tp3._2.WCFMeteo.IService1)(this)).Get_Value(inValue);
            s_DateValue = retVal.s_DateValue;
            s_DescValue = retVal.s_DescValue;
            return retVal.Get_ValueResult;
        }
        
        public System.Threading.Tasks.Task<tp3._2.WCFMeteo.Get_ValueResponse> Get_ValueAsync(tp3._2.WCFMeteo.Get_ValueRequest request) {
            return base.Channel.Get_ValueAsync(request);
        }
        
        public tp3._2.WCFMeteo.MeteoData Get_MeteoData() {
            return base.Channel.Get_MeteoData();
        }
        
        public System.Threading.Tasks.Task<tp3._2.WCFMeteo.MeteoData> Get_MeteoDataAsync() {
            return base.Channel.Get_MeteoDataAsync();
        }
        
        public tp3._2.WCFMeteo.MeteoData Get_MeteoDataByDateTime(string s_DateValueIn) {
            return base.Channel.Get_MeteoDataByDateTime(s_DateValueIn);
        }
        
        public System.Threading.Tasks.Task<tp3._2.WCFMeteo.MeteoData> Get_MeteoDataByDateTimeAsync(string s_DateValueIn) {
